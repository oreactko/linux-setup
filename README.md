...
* [ ] Add setup scripts for other distributions (Debian-based, Arch, etc.)
* [ ] Create an automatic system snapshot on first run
* [ ] Improve and expand the README documentation
